...
const Card: React.FC<ICard> = ({
  ...
  return (
    <div
      className="flex items-center justify-between gap-2 pb-2 w-full border-b-[1px] border-b-black1000 last-of-type:border-b-0"
      key={id}
    >
      ...
      <div className="flex flex-row gap-4 items-center">
        <div className="flex flex-row items-center gap-2">
          <button
            className="items-center justify-center font-bold text-4 hover:brightness-90 bg-white1000 p-2 rounded-2 transition-all ease-in delay-[50]"
